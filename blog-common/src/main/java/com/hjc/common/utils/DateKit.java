...
public class DateKit {
    ...
    public static Date dateFormat(String date, String dateFormat) throws ParseException {
        if(date == null) {
            return null;
        } else {
    ...
    public static Date getDatebyTime(Date date, int n) throws ParseException {
    ...
    public static String formatDateByDate(String dateTime, String dateFormat) {
        return dateFormat(new Date(dateTime), dateFormat);
    }
