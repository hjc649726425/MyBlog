...
import com.hjc.blog.dto.ErrorCode;
...
import com.hjc.common.utils.PatternKit;
...
public class IndexController extends BaseController {
     ...
     */
    @GetMapping(value = "/")
    @ActionLog(title = "Index", action = "首页")
    ...
    @ActionLog(title = "Index", action = "首页分页")
    ...
    @ActionLog(title = "Index", action = "文章页")
    ...
    @ActionLog(title = "Index", action = "文章页预览")
    ...
    @ActionLog(title = "Index", action = "注销")
    ...
    @ResponseBody
    @ActionLog(title = "Index", action = "评论")
    ...
    @ActionLog(title = "Index", action = "分类页")
    ...
    @ActionLog(title = "Index", action = "归档页")
    ...
    @ActionLog(title = "Index", action = "友链页")
     ...
     * 自定义页面,如关于的页面
     */
    @GetMapping(value = "/custom/{slug}")
    @ActionLog(title = "Index", action = "自定义页")
    public String page(@PathVariable(value = "slug") String slug, HttpServletRequest request) {
        ContentVo contents = contentService.getContents(slug);
        if (null == contents) {
            return this.render_404();
        }
        if (contents.getAllowComment()) {
    ...
    @ActionLog(title = "Index", action = "搜索页")
    ...
    @ActionLog(title = "Index", action = "标签页")
